...
[ ! -f $SRC_Source/mariadb-10.0.11.tar.gz ] && wget -c https://github.com/djamol/centos-INSTALLER/raw/master/src/openlite/mariadb-10.0.11.tar.gz -O mariadb-10.0.11.tar.gz
...
>>>>>>> 534eeb452712b41a03a2e135648b779226818f74
